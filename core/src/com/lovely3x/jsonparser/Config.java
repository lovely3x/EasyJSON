...
public class Config {
    ...
    public Config(JSONAdapter parser, JSONMatcher matcher, SuperObjectCreator creator, JSONPairFactory pairFactory, ClassCreator classCreator, JSONFormatter mFormatter) {
        this.parser = parser;
    ...
    public static Config createDefault() {
        ...
        config.parser = new JSONAdapter(config);
