 ...
 */
public class JSONAdapter implements com.lovely3x.jsonparser.parser.JSONParser {

    private String TAG = "JSONAdapter";
    ...
    private class GJSONSource implements JSONSource {
        private final Config mConfig;
